...
$vCenterInstance = "10.0.88.11"     #vCenter to deploy VM
$Cluster = "VSANCluster"             #vCenter cluster to deploy VM
$VMTemplate = "Linux Template"          #vCenter template to deploy VM
$CustomSpec = "New Customization Specification"          #vCenter customization to use for VM
$Location = ""            #Folderlocation in vCenter for VM
$DataStore = "vsanDatastore"           #Datastore in vCenter to use for VM
